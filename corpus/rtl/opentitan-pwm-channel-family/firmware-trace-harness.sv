...
module opentitan_pwm_firmware_trace_harness #(
  ...
  input  logic                         clk_i,
  input  logic [NOutputs-1:0]          enable_write_i,
  input  logic [NOutputs-1:0]          invert_write_i,
  input  logic [NOutputs-1:0]          parameter_write_i,
  input  logic [NOutputs-1:0]          duty_cycle_write_i,
  input  logic [NOutputs-1:0]          blink_parameter_write_i,
  ...
  pwm_core_flat #(
    ...
    .pwm_en_qe_i(enable_write_i),
    .invert_q_i(channel_invert_i),
    .invert_qe_i(invert_write_i),
    .pwm_param_phase_delay_q_i(phase_delay),
    .pwm_param_phase_delay_qe_i(parameter_write_i),
    .pwm_param_blink_en_q_i(blink_enable_i),
    .pwm_param_blink_en_qe_i(parameter_write_i),
    .pwm_param_htbt_en_q_i(heartbeat_enable_i),
    .pwm_param_htbt_en_qe_i(parameter_write_i),
    .duty_cycle_a_q_i(duty_cycle_a),
    .duty_cycle_a_qe_i(duty_cycle_write_i),
    .duty_cycle_b_q_i(duty_cycle_b),
    .duty_cycle_b_qe_i(duty_cycle_write_i),
    .blink_param_x_q_i(blink_parameter_x),
    .blink_param_x_qe_i(blink_parameter_write_i),
    .blink_param_y_q_i(blink_parameter_y),
    .blink_param_y_qe_i(blink_parameter_write_i),
    .alert_test_i(2'b00),
    .pwm_o(pwm_o)
  );
endmodule
