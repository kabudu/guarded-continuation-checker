// Repository-authored persistent-disturbance plant for the baseline.
module WashingPlant(
    ...
    always @(posedge clock) begin
        ...
        if (controller_fault) begin
            ...
            door_open <= door_open || door_event;
            imbalance <= imbalance || imbalance_event;
            motor_failed <= motor_failed || motor_failure_event;
            if (water_intake && !spin) begin
                if (water_level != 2'd3)
