// Repository-authored sensor-stuck plant for the composed-witness baseline.
module WashingPlant(
    ...
    // The physical door state remains observable to the safety monitor, but
    // the controller-facing lid sensor is stuck high.
