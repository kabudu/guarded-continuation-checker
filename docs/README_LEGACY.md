...
# Historical full project README

This document preserves the former long-form repository landing page. The
current [project README](../README.md) and [documentation map](README.md)
provide the maintained entry points.
